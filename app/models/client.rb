...
class Client < ActiveRecord::Base
  include Likeable
  attr_accessible :address, :description, :name, :opening_hour, :phone_num, :avatar, :industry_list, :category, :category_id, :district, :district_id, :remove_avatar, :avatar_cache, :latitude, :longitude
