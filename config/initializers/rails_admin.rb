# RailsAdmin config file. Generated on March 30, 2013 16:45
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Epoch Client', 'Admin']
  ...
  config.authorize_with do
    redirect_to '/clients/list', error: 'No such route for current user' unless current_user.has_role? 'admin'
  end
  ...
  # config.excluded_models = ['Client', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Client', 'Role', 'User']
  ...
  #     configure :opening_hour, :string 
  #     configure :address, :string 
  #     configure :phone_num, :string 
